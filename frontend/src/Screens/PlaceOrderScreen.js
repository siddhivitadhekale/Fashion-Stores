      ...
      >
        ...
        <Flex direction="column">
          ...
          <Box borderBottom="1px" py="6" borderColor="gray.300">
            ...
            <Text>
              <strong fontSize={["xs", "xl", "2xl"]}>Address: </strong>
        ...
        >
          <Box>
            ...
            <Flex
              ...
              justifyContent="space-between"
            >
              <Text fontSize={["sm", "md", "lg", "xl"]}>Items</Text>
            ...
            <Flex
              ...
              justifyContent="space-between"
            >
              <Text fontSize={["sm", "md", "lg", "xl"]}>Shipping</Text>
            ...
            <Flex
              ...
              justifyContent="space-between"
            >
              <Text fontSize={["sm", "md", "lg", "xl"]}>Tax</Text>
              <Text fontWeight="bold" fontSize={["md", "lg", "xl"]}>
                ₹{cart.taxPrice}
              </Text>
            </Flex>
            ...
            <Flex
              ...
              justifyContent="space-between"
            >
              <Text fontSize={["sm", "md", "lg", "xl"]}>Total</Text>
              <Text fontWeight="bold" fontSize={["md", "lg", "xl"]}>
                ₹{cart.totalPrice}
              </Text>
            </Flex>
